...
// SESSIONS_DIR doit pointer vers le point de montage du disque persistant
// Render (ex: /var/data/sessions) — sans ça, la session WhatsApp est perdue
// à chaque redéploiement et il faut re-scanner le QR.
const AUTH_DIR = path.resolve(process.env.SESSIONS_DIR || './sessions');
